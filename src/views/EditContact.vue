    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col">
                ...
                <p class="fst-italic">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Itaque, nam minus odit
                    exercitationem cum soluta aliquam possimus quam aspernatur, facere qui voluptatem tempora, quos
                    reprehenderit obcaecati id veniam aperiam suscipit.</p>
            </div>
        </div>
    </div>
    <div class="container mt-3">

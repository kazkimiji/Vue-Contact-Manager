    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col">
                ...
                <p class="fst-italic">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatum consequatur
                    maiores corporis,provident sapiente incidunt tenetur nam architecto, maxime similique est sequi
                    mollitia cum autem atque ab ullam ea laudantium?</p>
                <form>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
